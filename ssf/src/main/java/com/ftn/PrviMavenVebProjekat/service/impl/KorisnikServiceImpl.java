	...
	private Map<Long, User> readFromFile() {
    	...
    	try {
			...
			for (String line : lines) {
				...
				DateTimeFormatter formatter = DateTimeFormatter.ofPattern("d/MM/yyyy HH:mmHH:mm");
				...
				LocalDate dateofBirth = LocalDate.parse(tokens[8], formatter1);


				korisnici.put(Long.parseLong(tokens[0]), new User(id, ime, prezime, email, lozinka,UserName,creation,tip,dateofBirth));
